...
public class FileSelector extends JButton implements OptionEditor<File> {
    private JFileChooser fc;
    private File file;
    Consumer<JTree> stopEditing = JTree::stopEditing;

    public FileSelector() {
        setFocusable(false);
        addActionListener(e -> stopEditing.accept((JTree) SwingUtilities.getAncestorOfClass(JTree.class, FileSelector.this)));
        addActionListener(e -> {
            if (fc == null) {
